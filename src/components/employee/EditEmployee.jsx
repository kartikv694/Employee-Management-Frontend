...
export default function Edit() {
    ...
    async function getEmployee() {
        try {
            const { data } = await axios.get(`https://employee-management-backend-blond.vercel.app/api/v2/employee/single/${_id}`,
                {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        // console.log(semp)
        try {
            const { data } = await axios.put(`https://employee-management-backend-blond.vercel.app/api/v2/employee/update/${_id}`,
                emp,
                {
                    headers: {
                        Authorization: `Bearer ${auth?.token}`
