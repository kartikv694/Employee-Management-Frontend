// This File is For Updting Department Details
...
export default function EditDepartment() {
    ...
    useEffect(()=>{
        const getDepartment = async ()=>{
            try {
                const {data} = await axios.get(`https://employee-management-backend-ime7.onrender.com/api/v2/department/get/${_id}`,{
                    headers: {
    ...
    const hanldeSubmit = async (e) => {
        e.preventDefault()
        try {
            const {data} =  await axios.put(`https://employee-management-backend-ime7.onrender.com/api/v2/department/update/${_id}`,
            {
